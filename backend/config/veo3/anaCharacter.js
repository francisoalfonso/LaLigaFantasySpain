...
const ANA_CHARACTER_BIBLE =
    'A 32-year-old Spanish sports analyst with long blonde wavy hair, green-hazel eyes, athletic build, wearing a red Fantasy La Liga polo shirt. Natural smile, confident posture, warm and approachable professional broadcaster energy';

// URLs imágenes Ana Real - Rotación automática para variedad visual
const ANA_IMAGE_URLS = {
    // ✅ IMAGEN BASE FIJA - Body outfit reference (mismo sistema que NanoBanana)
    // NOTA: Sincronizado con flp-nano-banana-config.json (12 Oct 2025)
    fixed: 'https://ixfowlkuypnfbrwawxlx.supabase.co/storage/v1/object/public/flp/ana/ana-peinido2-03.png',
...
const STUDIO_CONFIGURATIONS = {
    ...
    dramatic: {
        description:
            'modern Fantasy La Liga studio with dramatic lighting creating excitement and intrigue',
...
const AUDIO_ENVIRONMENTS = {
    ...
    dramatic:
        'Dynamic sports broadcast ambiance with tension-building audio cues, rising musical sting',
    breaking: 'Urgent news broadcast ambiance with alert tones',
    analysis:
        'Professional studio ambiance with data processing sounds building to statistical triumph'
};
